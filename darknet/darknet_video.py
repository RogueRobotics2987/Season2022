...
def inference(darknet_image_queue, detections_queue, fps_queue, sd):
    while cap.isOpened():
...
if __name__ == '__main__':
    ...
    sd.putNumber('someNumber', 6) #put x y coords to send to networkTables isr
    #sd.putNumber('Left X', 6) #put x y coords to send to networkTables isr
    sd.putNumberArray('Top Y', [4,6]) #put x y coords to send to networkTables isr
    ...
    Thread(target=inference, args=(darknet_image_queue, detections_queue, fps_queue, sd)).start()
