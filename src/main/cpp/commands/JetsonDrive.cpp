...
JetsonDrive::JetsonDrive(DriveTrain* drivetrain) {
  ...
  // std::cout<<"JetsonDrive"<<std::endl;
}

// Called when the command is initially scheduled.
void JetsonDrive::Initialize() {
m_drivetrain->Reset();

}

// Called repeatedly when this Command is scheduled to run
void JetsonDrive::Execute() {

  m_drivetrain->JetsonControl();
...
void JetsonDrive::End(bool interrupted) {m_drivetrain->Drive(0,0);}

// Returns true when the command should end.
bool JetsonDrive::IsFinished() {
  return false;
}
